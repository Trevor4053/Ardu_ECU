...
<body>
   ...
   <div class="content">
      <div class="card-grid">
        <div class="card">
          <p class="card-title">Throttle</p>
          <canvas id="gauge-thr"></canvas>
        </div>
        <div class="card">
          <p class="card-title">Starter</p>
          <canvas id="gauge-str"></canvas>
        </div>
         <div class="card">
          <p class="card-title">Glow</p>
          <canvas id="gauge-glow"></canvas>
        </div>
        <div class="card">
...
// Create Starter Gauge
var gaugeStr = new LinearGauge({
  renderTo: 'gauge-str',
  width: 100,
  height: 200,
  units: "Starter",
...
// Create Glow Power Gauge
var gaugeGlow = new LinearGauge({
  renderTo: 'gauge-glow',
  width: 100,
  height: 200,
  units: "Glow",
    ...
    if (this.readyState == 4 && this.status == 200) {
      ...
      var throttle = myObj.throttle;
       var starter = myObj.starter;
        var glow = myObj.glow;
       var fuel = myObj.fuel;
      gaugeThr.value = throttle;
      gaugeTemp.value = temp;
      gaugeStr.value = starter;
      gaugeGlow.value = glow;
