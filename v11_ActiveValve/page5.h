const char htmlPage5[] PROGMEM = R"=====(
<html>
<head>
...
<body>
   ...
   <div class="content">
    <p>Data_File:<span id="datafilename"></span></p>
      ...
      <div>
      <p>  <h4>Control Modes</h4> </p>
      <a href="/ModeNormal" class="button" >Auto_Start</a>
            <a  href="/ModeStarter" class="button">Starter Control</a>
            <a href="/ModeFuel" class="button">Fuel control</a>
            <a  href="/PumpPrime" class="button">Pump Prime</a>
             <a  href="/ResetError" class="button">Clear Error</a>
            
    </div>
    <div>
     <p>  <h4>File Recording</h4> </p>
      <a href="/StopRecording" class="button" >Stop Recording</a>
            <a  href="/StartRecording" class="button">Start Recording</a>
            <a href="/NewFile" class="button">Open New File</a>
              <a href="/DeleteAll" class="button">Delete All Files</a>
        </div>   
    <script>
